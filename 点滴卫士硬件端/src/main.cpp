...
void loop() {
  ...
  if ((isLevelChanging && (timer - lastTimer > 1000))) {
     levelUpdate();
  }
  else if(isLevelChanging && (timer - lastTimer) <= 1000){
